...
const openVideoFromUser = exports.openVideoFromUser = () => {
    ...
    const OBD_file = path.join(app.getAppPath(), 'app/data/ID001_TEMP3_OBD.json')
    const infras_seg_result_file = path.join(app.getAppPath(),
        'app/data/ID001_TEMP3_infras_segmentation_result.json')
    const traffic_seg_result_file = path.join(app.getAppPath(), 'app/data/ID001_TEMP3_traffic_segmentation_result.json')
